...
export default function NewPropertyPage() {
  ...
  const { register, handleSubmit, setValue, watch, formState: { errors, isSubmitting } } = useForm<PropertyFormValues>({
    ...
    defaultValues: { type: "FLAT", purpose: "RENT", negotiable: false },
  });
  ...
  const onSubmit = async (data: PropertyFormValues) => {
    ...
    try {
      ...
      if (err.response?.status === 403 && errorMsg.includes("KYC")) {
        showToast("You need to verify your KYC first", "error");
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <p className="text-gray-500 text-sm mb-8">Fill in the details below to list your property on GharBhada.</p>
